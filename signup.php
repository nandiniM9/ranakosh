...
?>
      ...
      <?php if(isset($done)) 
      { ?>
    <div class="successmsg"><span style="font-size:100px;">&#9989;</span> <br> <p>You have registered successfully .</p> <br> 
   
    <center><a href="login.php" value="Submit" style="font-size:20px">LOGIN HERE</a><br><br></center>
    <br>
      <?php } else { ?>
